...
- [x] No secrets, passwords, or tokens in the repo

## Documentation
- [x] README updated if usage/behavior changed
- [x] CHANGELOG updated under **Unreleased** (or new version entry if tagging)
- [x] Backlog updated if tasks were completed or new ones discovered
- [x] New diagrams/screenshots added to `/docs` if relevant
